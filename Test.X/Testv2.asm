...
#define	KPD	PORTA, 3    ; set to disable keypad
#define	BARREL	PORTB, 0    ; Barrel proximity sensor, interrupts on rising edge
#define	COL	PORTB, 6    ; Column proximity sensor, interrupts
...
ARMTIME	equ	D'82'	    ; Arm timer in constant: 0.0262*61 = 1.51 sec
ARMTIME2 equ	D'67'	    ; Out-constant
ARMTIME3 equ	D'5'	    ; Just the real arm time*3 for the optime
COLTIME	equ	D'16'	    ; Column pass time constant: 0.125*8=1sec (T1)
			    ; the rest are all T0
...
MAX	equ	D'134'	    ; max time = 400 cm / SPEED cm/sec
...
Init	bsf	STATUS, RP0	; go to bank 1
	; Initialize inputs
	movlw	B'11110111'	; set PORTA to input (sensors)
	movwf	TRISA
